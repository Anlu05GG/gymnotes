...
type Dia = { d: number | null; iso?: string; entreno?: boolean; sesionId?: number }
...
export class CalendarioComponent implements OnInit {
  ...
  anteriorMes() {
    if (this.mes0 === 0) { this.mes0 = 11; this.anio--; } else { this.mes0-- }
    this.cargarMes()
  }

  siguienteMes() {
    if (this.mes0 === 11) { this.mes0 = 0; this.anio++; } else { this.mes0++ }
    this.cargarMes()
  }
